...
const Navbar = () => {
    ...
    return (
        <nav className="relative flex flex-wrap items-center justify-between  bg-green-800  shadow-xl  px-2   ">
            <div className="container px-4 mx-2 md:mx-32 flex flex-wrap items-center justify-evenly">
                <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
                    <Link href="/">
                        <div className=" cursor-pointer rounded-full flex justify-center">
                            <Image
                ...
                >
                    <motion.ul
                        ...
                        className="flex flex-col lg:flex-row list-none lg:ml-auto gap-8 "
                    >
                        <li className="nav-item">
                            <Link
                                ...
                                href="/About"
                            >
                                <span className="ml-2 text-yellow-300 hover:opacity-75 text-xl lg:text-2xl transition-all duration-300 cursor-pointer">
                                    Home
                                </span>
                            </Link>
                        </li>
