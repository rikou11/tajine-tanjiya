        ...
        {testmonials.map((i) => {
          return (
            <div key={i} className={styles.cardSlider}>
              <div
                className={`${styles.card} flex-col py-2 px-4  md:py-4 md:px-8 shadow-lg rounded-lg bg-white `}
              >
                <h1 className="font-bold text-lg">{i.name}</h1>
                <h2 className="text-slate-700 font-thin ">{i.date}</h2>
                <h3 className="flex ">
                  <svg
                ...
                <p className="text-sm mt-5">{i.discroption}</p>
              </div>
            </div>
          );
        })}
